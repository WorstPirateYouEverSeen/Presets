...
public unsafe class M12S_P2_Rep_1_Clones : SplatoonScript
{
    ...
    private static readonly Vector3 PosNE = new(105f, 0f, 95f);
    private static readonly Vector3 PosSE = new(105f, 0f, 105f);
    private static readonly Vector3 PosSW = new(95f, 0f, 105f);
    private static readonly Vector3 PosNW = new(95f, 0f, 95f);

    private static readonly Vector3 NavMeleeLeft = new(101.1f, 0f, 92.9f);
    private static readonly Vector3 NavMeleeRight = new(92.9f, 0f, 101.1f);
    private static readonly Vector3 NavRangeLeft = new(113.65f, 0f, 100f);
    private static readonly Vector3 NavRangeRight = new(100f, 0f, 113.65f);
    private static readonly Vector3 NavMeleeDebuff = new(101f, 0f, 101.5f);
    private static readonly Vector3 NavRangeDebuff = new(86.65f, 0f, 100.5f);
